...
async def triage_router_node(state: AidaState, llm) -> dict:
    ...
    system_prompt = (
        ...
        "4. 'os_diag' -> Use this IF the machine is slow, freezing, running out of memory or disk space, a process is using too much CPU, or asks whether a service is running.\n"
